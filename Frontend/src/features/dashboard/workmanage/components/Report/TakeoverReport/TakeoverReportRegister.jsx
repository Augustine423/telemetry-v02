    ...
    <>
        ...
        <div className="border-b pb-5">
          <table className="w-full">
            <tr className="border-b">
              ...
              <th className="text-gray-700 text-start text-base w-52">
                Work detail
              </th>
            ...
            <tr className="w-full py-5">
              ...
              <td className="py-5 ">
                <input
                  type="text"
                  placeholder="Follow Handover Report"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
              </td>
            ...
            <tr className="w-full border-b ">
              <td className="text-center py-5">Reference</td>
            ...
            <tr className="w-full">
              <td className="text-center ">Takeover Sign</td>
                    ...
                    <div className="flex gap-4 w-full py-5">
                      <label className="inline-flex items-center w-40">
                        <input
                          ...
                          defaultChecked
                        />
                        <span className="ml-2 text-sm text-gray-700">Sign</span>
                      </label>
      ...
      <div className="mb-8 py-5">
        ...
        <div className="border-b pb-5">
          ...
          <div className="mx-10">
            <div className=" w-full flex justify-between items-center">
              <label className="block text-sm font-medium mb-1 w-[20%]">
                Takeover Sign
              </label>
      ...
      <div className="mb-8 py-5">
        ...
        <div className="border-b pb-5">
          <div className="mx-10">
            <div className="w-full flex justify-between items-center">
              <label className="block text-sm font-medium mb-1 w-[28%]">
                Takeover Sign
              </label>
              <div className="w-full">
                {workItems.map((item) => (
...
export default TakeoverReportRegister;
