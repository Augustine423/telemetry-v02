...
import MechanicDetailPage from "../pages/MechanicDetailPage.jsx";
import { deleteMechanic, fetchMechanics } from "../../../../../stores/informationData/mechanicSlice.js";
import MechanicDetail from "./MechanicDetail.jsx";

const MechanicDetailHeader = () => {
  ...
  const handleDeleteBtn = async () => {
    ...
    try {
      ...
      await dispatch(deleteMechanic(id)).unwrap(); // Dispatch delete action
      dispatch(fetchMechanics()); // Refresh the list of companies
      navigate("/dashboard/mechanic-overview"); // Redirect after deletion
    } catch (error) {
...
export default MechanicDetailHeader