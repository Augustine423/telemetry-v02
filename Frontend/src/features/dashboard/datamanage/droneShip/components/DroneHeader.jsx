...
import DroneRegisterPage  from "../../droneShip/pages/DroneRegisterPage"
import DroneTableView from "./DroneTableView";
import DroneGridView from "./DroneGridView";
...
const DroneHeader = () => {
  ...
  return (
    ...
    {/* Content Section */}
    <main className="p-10">
      {selectedItem.selectedItem === "Drone" ? (
        activeButton === "register" ? (
          <DroneRegisterPage />
        ) : activeButton2 === "table" ? (
          <DroneTableView />
