...
const DroneAirSpeedSensorPopupTable = ({ onClose }) => {
          ...
          <table className="w-full">
            ...
            <tbody className=" ">
              <tr>
                ...
                <td className="px-4 py-3 text-sm text-gray-700">A13589</td>
...
export default DroneAirSpeedSensorPopupTable;
