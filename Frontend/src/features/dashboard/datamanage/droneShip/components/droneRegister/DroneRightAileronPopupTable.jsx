...
const DroneRightAileronPopupTable = ({ onClose }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-2xl">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold">Right Aileron Select</h2>
          <button
            onClick={closePopup}
          ...
          <table className="w-full">
            ...
            <tbody className=" ">
              <tr>
                ...
                <td className="px-4 py-3 text-sm text-gray-700">U13589</td>
...
export default DroneRightAileronPopupTable;
