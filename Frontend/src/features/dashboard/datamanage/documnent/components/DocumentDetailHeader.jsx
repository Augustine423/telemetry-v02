...
import DocumentDetail from "../../documnent/components/DocumentDetail.jsx"
import { deleteVessel, fetchVessels } from "../../../../../stores/informationData/vesselSlice.js";

const MaterialDetailHeader = () => {
  const { id } = useParams();
  ...
  const handleDeleteBtn = async () => {
    ...
    try {
      ...
      navigate("/dashboard/material-overview"); // Redirect after deletion
    } catch (error) {
